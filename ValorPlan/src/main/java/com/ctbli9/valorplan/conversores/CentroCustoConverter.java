...
public class CentroCustoConverter implements Converter {
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		...
		try {
			con = new ConexaoDB();
			cenc = new CentroCustoService(con).pesquisarCentroCusto(Integer.parseInt(value));
	...
	public String getAsString(FacesContext context, UIComponent component, Object object) throws ConverterException {
		...
		CentroCusto cenc = (CentroCusto) object;
		return Integer.toString(cenc.getCdCentroCusto());
	}
}
